...
$(document).ready(function()
{
  ...
  $(".menu-bar").on('click', function(e){
      e.preventDefault();
      $(".header-2 nav").toggleClass('hide');
      $("span", this).toggleClass("fa-bars fa-times-circle");
      $(".main-menu").addClass('mobile-menu');
  });
    
    //    const selectCountry = (country,flag)=>{
    //     document.getElementById('countryName').innerHTML = country;
    //     document.getElementById('countryFlag').src = "images/flag/"+flag;
    //     console.log(country)
    // };
    // selectCountry('فارسی', 'iran.png');
