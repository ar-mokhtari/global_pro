(function(factory) {
    ...
    $.extend(Fastsearch.prototype, {
        ...
        showResults: function($content) {
            ...
            // this.$el.trigger('fstSelect:resultsOpenedClass');
...
(function(root, factory) {
    ...
    $.extend(Fastselect.prototype, {
        ...
        setupSingleElement: function(onDone) {
            ...
            if (this.options.removeQuickSearch) {
                this.$queryInput = $('<span>');
                this.$controls.addClass('no-quick-search');
            }
            else {
        ...
        setupEvents: function() {
            ...
            if (this.isMultiple) {
                ...
                this.$el.on(this.namespaceEvents('click'), selectorFromClass(options.toggleButtonClass), function() {
                    ...
                    // <<< omid -> self.show(true) replaced by self.show(option.autoFocus)
                    self.$el.hasClass(options.activeClass) ? self.hide() : self.show(options.autoFocus);
        ...
        show: function(focus) {
            ...
            this.documentCancelEvents('on');
            this.$el.trigger('fstSelect:show:activeClass');
        ...
        hide: function() {
            ...
            this.documentCancelEvents('off');
            this.$el.trigger('fstSelect:hide:activeClass');
