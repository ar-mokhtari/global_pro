...
/* @var $searchModel app\modules\Codnitive\OfficeAutomation\models\SendlettersSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'صندوق ارسالی';
                ...
                [
                    ...
                    'value' => function ($model) {
                        return Html::activeDropDownList(
                            $model, 'FullNameReciever', \yii\helpers\ArrayHelper::map(
                            dektrium\user\models\User::find()->select(['id', 'fullname'])->
                            where(['IN', 'id', \app\modules\codnitive\OfficeAutomation\models\VwRecieveletter::find()->select(['UsersID_Reciever'])->
                            where(['LettersID' => $model->LettersID])])->
                            all(), 'id', 'fullname'),
                            ['class' => 'center-block', 'style' => 'border:none']);
                    },
                    'headerOptions' => ['style' => 'text-align:center;'],
                    'hAlign' => 'right',
                    'vAlign' => 'middle',
