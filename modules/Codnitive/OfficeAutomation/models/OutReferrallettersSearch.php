...
/**
 * OutReferrallettersSearch represents the model behind the search form of `app\modules\Codnitive\OfficeAutomation\models\VwReferralletters`.
 */
class OutReferrallettersSearch extends VwReferralletters
{
    /**
     * {@inheritdoc}
     */
