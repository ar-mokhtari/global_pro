...
/**
 * ReadedlettersSearch represents the model behind the search form of `app\modules\Codnitive\OfficeAutomation\models\VwRecieveletter`.
 */
class ReadedlettersSearch extends VwRecieveletter
{
    /**
     * {@inheritdoc}
     */
    ...
    public function search($params)
    {
        ...
        if ($userID) {
            ...
            andWhere(['SendLettersReadType' => 1]);
        } else {
            throw new NotFoundHttpException('ReadLetter/P12');
        }
