...
/**
 * ForcelettersSearch represents the model behind the search form of `app\modules\Codnitive\OfficeAutomation\models\VwRecieveletter`.
 */
class ForcelettersSearch extends VwRecieveletter
{
    /**
     * {@inheritdoc}
     */
    ...
    public function search($params)
    {
        ...
        if ($userID) {
            ...
            where(['or', ['UsersID_Reciever' => $userID]])->
            orWhere(['UsersID_FK' => $userID])->
            andWhere(['LettersDraftType' => 1])->
            andWhere(['LettersTypeOfAction' => 2]);
        } else {
            throw new NotFoundHttpException('خـطا: ForceLetter/P18');
        }
