...
/**
 * VwRecieveletterSearch represents the model behind the search form of `app\modules\Codnitive\OfficeAutomation\models\VwRecieveletter`.
 */
class VwRecieveletterSearch extends VwRecieveletter
{
    ...
    public function search($params)
    {
        ...
        if ($userID) {
            ...
            andWhere(['LettersDraftType' => 1])->orderBy(['LettersID' => SORT_DESC]);
        } else {
            throw new NotFoundHttpException('خـطا: VwLetters/P20');
        }
