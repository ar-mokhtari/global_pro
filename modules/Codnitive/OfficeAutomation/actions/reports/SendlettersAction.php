...
use app\modules\Codnitive\OfficeAutomation\models\SendlettersSearch;


/**
 * LettersController implements the CRUD actions for Letters model.
 */
class SendlettersAction extends MainAction
{
    ...
    {
        parent::run();
        $searchModel = new SendlettersSearch();
        $dataProvider = $searchModel->search(\Yii::$app->request->queryParams);

        return $this->controller->renderAjax('../sendletters/index', [
