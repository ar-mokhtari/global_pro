...
use app\modules\Codnitive\OfficeAutomation\models\VwRecieveletterSearch;


/**
 * LettersController implements the CRUD actions for Letters model.
 */
class RecieveletterAction extends MainAction
{
    ...
    public function run()
    {
        ...
        return $this->controller->renderAjax('../recieveletter/index', [
