...
return array (
  ...
  'If you cannot click the link, please try pasting the text into your browser' => 'اگر برای کلیک بر روی این لینک مشکلی دارید لطفا آدرس را در مرورگر کپی کنید',
  ...
  'Your account has been created successfully.' => 'حساب کاربری شما با موفقیت ساخته شد.',
  'Cellphone' => 'شماره همراه',
  'A new password sent to your cellphone, please change it once you logged in.' => 'یک گذرواژه جدید به شماره‌ی همراه‌تان ارسال شد، به محض ورود آن را تغییر دهید.',
  'New password sent' => 'گذرواژه جدید ارسال شد'
);
