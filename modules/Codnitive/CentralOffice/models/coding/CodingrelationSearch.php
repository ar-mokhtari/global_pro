 ...
 */
class CodingrelationSearch extends Codingrelation
{
    ...
    {
        $AllModals = Codingrelation::find()->where(['first_code' => app()->session->get('JobsID')]);
        $query = $AllModals;
        if (isset($params['CodingrelationSearch'])) {
            $this->_searchParams = $params['CodingrelationSearch'];
