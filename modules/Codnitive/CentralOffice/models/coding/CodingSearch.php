 ...
 */
class CodingSearch extends Coding
{
    ...
    {
        $getArgument = \Yii::$app->request->get();
        $level = $getArgument['level'];
        $grp = $getArgument['grp'];
        $AllModals = Coding::find()->andWhere(['level' => $level])->andWhere(['grp' => $grp]);
        $query = $AllModals;
        if (isset($params['CodingSearch'])) {
            $this->_searchParams = $params['CodingSearch'];
