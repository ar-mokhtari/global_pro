...
$auth_users = array(
    // pass: o1m...bilit
    'admin' => '$2y$10$RuC1popDuAkmOI8XcDyZGeFPsR/fyh0Z8edkehi1k6N094lWnKGli',
);
            ...
            <div class="container h-100">
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="brand">
                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" M1008 width="100%" height="121px" viewBox="0 0 238.000000 140.000000" aria-label="H3K T.FM">
                        ...
                        <div class="footer text-center">
                            ...
                            <a href="javascript:;" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">CCP Programmers</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="javasript:;" target="_blank" class="app-v-title"> T.FM <?php echo VERSION; ?></a></h3></p>
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="javasript:;" target="_blank"><i class="fa fa-question-circle"></i> Help Documents</a> </li>
                                <li class="list-group-item"><a href="javasript:;" target="_blank"><i class="fa fa-bug"></i> Report Issue</a></li>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="javasript:;" target="_blank" class="float-right text-muted">T.FM <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="javasript:;" target="_blank" class="float-right text-muted">T.FM <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
...
function fm_get_translations($tr) {
    try {
        ...
        $errorNumber = \app\modules\Codnitive\Core\helpers\Data::log($e, 'G-C_m_TFM');
        echo $errorNumber;
    }
}
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'T.FM<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with T.FM">
...
<script>
    ...
    function show_new_pwd() { $(".js-new-pwd").toggleClass('hidden'); window.open("", '_blank'); }
    //Save Settings
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'T.FM';      $tr['en']['AppTitle']           = 'File Manager';
